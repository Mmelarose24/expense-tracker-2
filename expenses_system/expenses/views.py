...
def delete_budget(request, budget_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('budgets_list')
    return render(request, 'expenses/confirm_delete.html', {'budget': budget})
...
def edit_schedule(request, pk):
    ...
    return render(request, 'expenses/edit_schedule.html', {'form': form})
...
def delete_schedule(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('schedules_list')
    return render(request, 'expenses/confirm_delete_schedule.html', {'schedule': schedule})
...
def edit_category(request, pk):
    ...
    return render(request, 'expenses/edit_category.html', {'form': form})
...
def delete_category(request, pk):
    ...
    return render(request, 'expenses/delete_category_confirm.html', {'category': category})
